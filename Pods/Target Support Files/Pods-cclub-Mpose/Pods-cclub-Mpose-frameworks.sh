...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BvMapCluster/BvMapCluster.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PersianDatePicker/PersianDatePicker.framework"
